...
class BooleanFieldListFilter(FieldListFilter):
    def __init__(self, field, model, field_path, **settings):
        ...
        if settings.get("choices"):
            ...
            self.lookup_choices = (("1", _("Yes")), ("0", _("No")))
...
FieldListFilter.register(
    lambda f: isinstance(f, models.CharField), ChoicesFieldListFilter
)
    ...
    class ArrayFieldListFilter(FieldListFilter):
        def __init__(self, field, model, field_path, **settings):
            ...
            if settings.get("choices"):
                ...
                self.lookup_choices = [
                    (f"{choice}", title)
                    for choice, title in self.field.base_field.flatchoices
                ]
...
FieldListFilter.register(
    lambda f: isinstance(f, models.DateField), DateTimeFieldListFilter
)
FieldListFilter.register(
    lambda f: isinstance(f, models.DateTimeField), DateTimeFieldListFilter
)
